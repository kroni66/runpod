...
// Web-compatible API implementation for when running outside Electron
export const webRunpodAPI = {
...
// Get the appropriate API implementation (Electron or web)
export const getRunpodAPI = () => {
  return (window as any).runpodAPI || webRunpodAPI;
};

// Type definitions
export type RunpodAPI = typeof webRunpodAPI;
